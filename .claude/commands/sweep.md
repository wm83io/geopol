...
The step does not require resolving the principal question every cycle; it requires not pretending it is settled when discriminating evidence is absent, and it requires routing the absence into structural change once the 5th-cycle threshold trips and through the provisional window thereafter.
