...
Load into working context. Read from filesystem MCP at `D:\claude\geopol`.
...
3. **Last 2-3 probe sweeps:** read most recent files in `D:\claude\geopol\probes\sweeps\`
   in chronological order. Without 2+ cycles to compare, defer the audit.
4. **Last 2-3 SITREPs:** read most recent files in `D:\claude\geopol\sitreps\`
   in chronological order.

After producing the audit delta, write the patched Appendix B back to
`D:\claude\geopol\appendix\appendix-b-blind-spots.md` via filesystem MCP.
