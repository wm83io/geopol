...
Load into working context before any probe runs:

1. `iran-2026-sitrep-synthesis-v2.md` — current framework baseline
2. `iran-2026-sitrep-appendix-B-blind-spots.md` — probe specs (authoritative)
3. Most recent daily SITREP — current operational baseline

Record the current value of any framework variable a probe might move. Probes are deltas against this
baseline, not absolute readings.
