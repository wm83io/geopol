...
1. **Anchor:** `iran-2026-sitrep-synthesis-v2.md` — base framework. Today's annex is a delta against it. Do not rewrite.
2. **Last annex:** most recent `iran-2026-sitrep-day{N}-update.md` — establishes rolling baseline.
3. **Probe sweep output** for the current cycle — primary input for sections 2-4.
4. **Appendix B** (`iran-2026-sitrep-appendix-B-blind-spots.md`) — for section 6 probe status.
5. **Output schema** (`iran-2026-probe-output-schema.md`) — governs how probe findings map to framework variables.

If the probe sweep has not run for the current cycle, flag at the top of the SITREP and proceed with available data, noting reduced confidence. Do not silently skip.
